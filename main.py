...
#def convert_to_pdf():
    # content = request.json['html']
    # with tempfile.NamedTemporaryFile(suffix=".pdf", delete=False) as temp:
    #     pdfkit.from_string(content, temp.name)
    #     return send_file(temp.name, as_attachment=True, attachment_filename='student_info.pdf')
...
#             pdfkit.from_file(temp_html.name, temp_pdf.name, configuration=config)
#             return send_file(temp_pdf.name, as_attachment=True, attachment_filename='student_info.pdf')
